...
st.text("Data was presented showing how much wood was harvested, but what about how much \nacreage has been replanted? Below demonstrates that many countries are making a \nslow increase in their area of planted forest, showing a concentrated effort to \nreplenish stripped land.")
